# Infrastructure Skeleton — Phase 1.5
#
# Source of truth: `docs/infra/README.md` (normative).
# This file mirrors the normative document for operator convenience.
#
# IMPORTANT: If this file and the docs ever disagree, the docs are correct.
